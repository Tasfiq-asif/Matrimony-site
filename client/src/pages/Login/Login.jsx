...
function Login() {
  ...
  const { signInWithGoogle, signIn,  setLoading,user,loading } =
    useAuth();
    ...
    <div>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container flex items-center justify-center min-h-[calc(100vh-350px)] px-6 mx-auto">
          ...
          >
            <img className="w-auto h-[4rem] mx-auto" src={logo} alt="Logo" />

            <h1 className="w-1/3 pt-5 mx-auto pb-4 text-center text-darkPurple font-bold text-2xl capitalize border-b-2 border-darkPink dark:border-blue-400 dark:text-white">
              Log In
            </h1>
